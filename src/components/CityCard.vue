<template>
  <div class="py-6 px-3 bg-weather-secondary rounded-md shadow-md cursor-pointer">
    <div class="flex">
    ...
    <div
      class="flex items-center gap-2 pt-4 w-fit text-white cursor-pointer duration-150 hover:text-red-500"
